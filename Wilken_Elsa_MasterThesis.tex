...
\end{figure}    
	...
	This results in a larger uncertaintiy of the \ce{BrO}  SCD. Most of te \ce{BrO}  data are below the detection lime of \ce{BrO}$_{err}$/BrO$_{value}$<1/4. In comparison SCD's of \ce{SO2}  are in almost all cases (99.5\% of the data) above the detection limit. 
