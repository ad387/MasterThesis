...
%
%\begin{table}[h!]
%	\caption[Results for Tungurahua and Nevado del Ruiz.]{Results for Tungurahua and Nevado del Ruiz. The absolute amount of scans is and the amount of contaminated scans is shown. The fraction of \ce{SO2} SCDs above the plume limit is calculated when using the conventional NOVAC-routine (Described with NOVAC in the table).  The third row shows the amount of data above the plume limit if all contaminated data are excluded. If the scan is contaminated the share of data above the plume limit when using the NOVAC-routine or the new method are shown as well. The total amount of data above plume limit if the contaminated are evaluated with the new method are calculated. The row at the bottom shows how much the share of data above the plume limit increases if the new method for the contaminated data is used. The temporal difference between the measuring times of plume and reference is not longer than $\pm$2week. The maximal temperature difference is smaller then 3.3$^{\circ}$C ($\Delta T < 3.3^{\circ}$C). The maximal relative BrO fit error for the contaminated data is not larger as the corresponding BrO SCD. }
%	\subfigure{
...
%			\myrowcolour
%			\cellcolor{white}&New method: above plume limit&29.9\%&59.8\%\\            
%			In total: above plume limit &&7.3\%&14.0\%\\
%			\myrowcolour
%			Increase of data above plume limit &&24.7\%&37.1\%\\
%			\bottomrule            
%	\end{tabular}}
%	
%	\label{tab:calc1}
...
%\begin{table}[h!]
%	\centering
%	\caption{Results for Tungurahua and Nevado del Ruiz. all data}
%		\begin{tabular}{p{3cm}p{4cm}p{6cm}}
%			\toprule
%			&&Share of data above Plume limit\\
%			\toprule
%			\myrowcolour
%			\multirow{2}{*}{\cellcolor{white}Old method}&Tungurahua:& 6.4\%\\
%			&Nevado del Ruiz: &12.1\%\\
%			\midrule
%			\myrowcolour
%			\multirow{2}{*}{\cellcolor{white}Old method}&Tungurahua:& 5.5\%\\
%			&Nevado del Ruiz: & 8.8\%\\
%			\midrule
%			\myrowcolour
%			\multirow{2}{*}{\cellcolor{white}New method}&Tungurahua:& \textcolor{white}{0}7.3\% \hspace{0.5cm}(increase:24.7\%)\\
...
%\begin{table}[h!]
%	\centering
%	\caption{Results for Tungurahua and Nevado del Ruiz. contaminated scans }
%	\begin{tabular}{p{3cm}p{4cm}p{6cm}}
%		\toprule
%		&&Share of data above Plume limit\\
%		\toprule
%		\myrowcolour
%		\multirow{2}{*}{\cellcolor{white}Old method}&Tungurahua:& 15.3\%\\
%		&Nevado del Ruiz: & 32.8\%\\
%		\midrule
%		\myrowcolour
%		\multirow{2}{*}{\cellcolor{white}New method}&Tungurahua:& 29.9\% \hspace{0.5cm}(increase:24.7\%)\\
%		&Nevado del Ruiz: &59.8\%\hspace{0.5cm}(increase:37.1\%)\\
%		\hline      
%	\end{tabular}          	
%	\label{tab:calc3}
%\end{table}
