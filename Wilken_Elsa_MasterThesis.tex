...
%	 0.1). Burton et al. (2007) measured volcanic gas composition (H2O, CO2,
	...
	\subsection{Differential Optical Absorption Spectroscopy(DOAS)\label{DOAS}}
		\begin{figure}
			...
			\caption{Basic idea of the DOAS principle: Light attenuate due to broad band and narrow band effects. Broad band extinction caused by aerosols and Raylight scattering $\left(I_0\rightarrow I^{'}\right)$. The measured intensity $I$ is formed by narrow band effects due to differential absorption structures by trace gases with optical density $\tau^{'}$. Adapted from \cite{kern2009spectroscopic}}
	...
	\section{Contamination Problem\label{Chap:Cont}}	---------------------- genaue angebane tungurhaua u NEVADO\\
	\\
