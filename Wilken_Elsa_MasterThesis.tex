...
\section{Tungurahua}
 	...
 	6.0 percentage of all spectra are found as contaminated. If the contaminated spectra would be excluded, only 5.5 percent of the \ce{SO2}  column densities are above the plume limit  (see  Table \ref{tab:calc}). \\
 	A higher amount of spectra within the \ce{SO2}  limits can be found in the contaminated data. Here the percentage of data in the plume-limit is: 19.2 .
 	...
 	When performing the evaluating of the contaminated data with the contamination based method 41.9 percent of the resulting \ce{SO2}  column densities are in the plume limit. Thus the reliable amount of contaminated data increase by 118.7 percentage while the total amount of data increase by 45.2 percent.\\
...
77.9 percentage of the contaminated data have a \ce{SO2}  column density above $7\cdot10^{17}\quad \frac{molec}{cm^2}$ Thus we have as well a higher occurrence of the data above the plume limit within the contaminated data. 
...
%	Dh in den kontaminierten daten sind mit NOVAC ausgewerteten daten \underline{3.449} häufiger über dem plume limit\\
 ...
 \end{small}
	...
	We found an significant increase of the SCDs of \ce{SO2} and BrO while the conatmination based evaluation leads to a higher increase of the \ce{SO2} amount compared to the BrO evaluation. Thus the BrO/\ce{SO2} ratio decreases for values above zero.\\
