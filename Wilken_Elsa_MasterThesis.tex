...
%
	...
	\Cref{shiftPic} shows the Instrumental drift as a function of Time, to create \cref{shiftPic} we used Tungurahua data, 2008 from June to November.\\
	We found out that the time interval where it is still reasonable to use references is about 14 days. Therefore we only use references where the recording time difference between plume and reference is smaller than two weeks.
	\begin{figure}
		\centering
