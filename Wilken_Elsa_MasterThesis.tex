...
\begin{table}
	...
	\subfigure{	
		\begin{tabular}{p{2cm}p{1.8cm}|p{1.8cm}|}
			...
			\bottomrule		
	\end{tabular}}
	\caption{Results for Tungurahua and Nevado Del Ruiz. The absolut amount of data, the amount of data within the plume limit and the amount of contaminated data are shown. Furthermore are the amount of contaminated data which are evaluated with the contamination based method above the plume limit shown. Due to a lack of appropriate references a small amount of the contaminated data is not analysable. This amount is also listed in this table.}
	\label{tab:calc}
\end{table}
