...
\end{figure}    
	...
	The evaluation of the data from NOVAC is parted into the evaluation of \ce{SO2} and the evaluation of BrO. While the retrieving of \ce{SO2} is relatively easy due to the high amount of \ce{SO2} (magnitude of \ce{SO2} at Tungurahua $\approx 1e^{18}$), the BrO evaluation is much more problematic (as it can be seen in \Cref{fig:plumeref}). The magnitude of BrO SCD is around $\approx 1e^{14}$. 
...
\end{figure}
	...
	\begin{figure}
		...
		\centering
		\subfigure[D2J2200\_0]{\includegraphics[width=0.3\linewidth]{Bilder/DEpendencoOfBrOErrorOnVariables_absolutedep/D2J2200_0BrOERR_DiffTemp_Nevad}}
		\subfigure[D2J2201\_0]{\includegraphics[width=0.3\linewidth]{Bilder/DEpendencoOfBrOErrorOnVariables_absolutedep/D2J2201_0BrOERR_DiffTemp_Nevad}}
