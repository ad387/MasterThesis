...
%%
		...
		\begin{figure}[h]
			...
			\caption{Topographig Map of the Tungurahua Volcano. The predominant plume direction is shaded in yellow.  Four NOVAC stations are shown as red squares, the corresponding scanning geometry is sketched with black lines.}
		...
		The instruments records 53 spectra per Scan.
