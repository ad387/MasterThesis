...
\begin{frame}
	\frametitle{\color{mygreen} NOVAC \hspace{2cm}
		\color{mygreen}{\rule{0.8\textwidth}{2pt}}}
	Network for observation of volcanic and atmospheric change
	\begin{columns}[T]
		\only<1-3>{
			\begin{column}{.5\textwidth}
				\includegraphics[width=2.1\linewidth]{../../Bilder/NOVACPAD.pdf}
			\end{column}
			\hspace{2.2cm}
...
%
	...
	\begin{frame}
		...
		\only<1>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_4}
				%
		...
		\only<2>{
			...
			\begin{figure}
				\hspace{-3cm}
				\includegraphics[width=1.1\linewidth]{../../Bilder/Presentation1_v4_5a}
				%
				\label{fig:Presentation1_v4_6}
			\end{figure}
		}
		...
		%\begin{figure}
		%\centering
		%\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_6}
		%%
		%\label{fig:Presentation1_v4_6}
		%\end{figure}
		%}
		...
		%\begin{figure}
		%\centering
		%\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_7}
		%%
		%\label{fig:Presentation1_v4_7}
		%\end{figure}
		%}
		\only<4>{
			\begin{figure}
				\centering
				\includegraphics[width=1.05\linewidth]{../../Bilder/Presentation1_v4_8aa}
				%
				\label{fig:Presentation1_v4_8}
			\end{figure}
		}
		%\only<7>{
		%\begin{figure}
		%\centering
		%\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_9}
		%%
		%\label{fig:Presentation1_v4_9}
		%\end{figure}
		%}
		\only<5>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_10aa}
				%
				\label{fig:Presentation1_v4_10}
			\end{figure}
		}
		\only<6>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_9aaa}
				%
				\label{fig:Presentation1_v4_10}
			\end{figure}
		}
	\end{frame}
	\begin{frame}
		\frametitle{\color{mygreen}Determination of SO$_2$ Emission\\%\rule{_Breite_}{_Stärke_} %%andersrum ist's vertikal;)
			\color{mygreen}{\rule{0.8\textwidth}{2pt}}}
		\only<1>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_11}
				%
				\label{fig:Presentation1_v4_11}
			\end{figure}
		}
		\only<2>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_12}
				%
				\label{fig:Presentation1_v4_12}
			\end{figure}
		}
		\only<3>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_13}
				%
				\label{fig:Presentation1_v4_13}
			\end{figure}
		}
		\only<4>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_14}
				%
				\label{fig:Presentation1_v4_14}
			\end{figure}
		}
		\only<5>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_15}
				%
				\label{fig:Presentation1_v4_15}
			\end{figure}
		}
		\only<6>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_16}
				%
				\label{fig:Presentation1_v4_16}
			\end{figure}
		}
		\only<7>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_17}
				%
				\label{fig:Presentation1_v4_16}
			\end{figure}
		}
		\only<8>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_18}
				%
				\label{fig:Presentation1_v4_16}
			\end{figure}
		}
		\only<9>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_19}
				%
				\label{fig:Presentation1_v4_16}
			\end{figure}
		}
		...
		\only<10>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_20}
				%
				\label{fig:Presentation1_v4_18}
			\end{figure}
		}
		\only<11>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_21}
				%
				\label{fig:Presentation1_v4_19}
			\end{figure}
		}
		\only<12>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_22}
				%
				\label{fig:Presentation1_v4_19}
			\end{figure}
		}
		\only<13>{
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_23}
				%
				\label{fig:Presentation1_v4_19}
			\end{figure}}
		...
		\end{frame}
		\begin{frame}
			\frametitle{\color{mygreen}Plume composition measurement -BrO/SO$_2$\\%\rule{_Breite_}{_Stärke_} %%andersrum ist's vertikal;)
				\color{mygreen}{\rule{0.8\textwidth}{2pt}}}
			\only<1>{
				\begin{figure}
					\centering
					\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_25}
					%
					\label{fig:Presentation1_v4_19}
				\end{figure}}
			\end{frame}
			\begin{frame}
				\frametitle{\color{mygreen}The problem of choosing the right reference\\%\rule{_Breite_}{_Stärke_} %%andersrum ist's vertikal;)
					\color{mygreen}{\rule{0.8\textwidth}{2pt}}}
				\only<1>{
					\begin{figure}
						\centering
						\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_26}
						%
						\label{fig:Presentation1_v4_19}
					\end{figure}
				}\only<2>{
				\begin{figure}
					\centering
					\includegraphics[width=1\linewidth]{../../Bilder/Presentation1_v4_27}
					%
					\label{fig:Presentation1_v4_19}
				\end{figure}
			}
